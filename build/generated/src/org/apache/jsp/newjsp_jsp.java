  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            String symptom="Irritable";//request.getParameter("k");
            int id=0;int i=1;
            int wt=0;
            try{
               ...
               if(rs.next()){
                id=Integer.parseInt(rs.getString("id"));
                 String query1="select max(weight) from symptom_info where id='"+id+"'";
            ...
            out.print("<th id='header'>SNo.</th><th id='header'>Medicine Name</th>"); 
            try{
               Class.forName("com.mysql.jdbc.Driver");
               Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medicine","root","");
               ...
               ResultSet rs=stmt.executeQuery(query);
               while(rs.next()){
                   if(wt==Integer.parseInt(rs.getString("weight"))){
                       out.print("<tr bgcolor='red'><td>"+i+++"</td><td>");
